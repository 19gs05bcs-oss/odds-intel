-- Fresh Supabase install: events with markets JSON + change-only history
-- For existing DBs that already have the old per-selection tables, run:
--   supabase/alter_events_markets_json.sql
